...
public enum Gun {
    TS19(Items.TS19, 7, 3.5, 21, 400, 400, 2500, 0.7F, false),
    SCATTER3(Items.SCATTER3, 4, 5, 25, 500, 300, 1500, 1.0F, false),
    P69(Items.P69, 10, 3, 15, 150, 2500, 4500, 0.6F, false),
    VIPER9(Items.VIPER9, 16, 5, 5, 30, 5000, 10000, 0.0F, false),
    EXTENSO18(Items.EXTENSO18, 12, 4.5, 5, 50, 3000, 6000, 0.5F, false),
