...
public enum Equip {
    SWAT("swat", ChatColor.translateAlternateColorCodes('&', "&8&l[&1SWAT&8&l]"), Arrays.asList(Items.SCHILD, Items.SKEV, Items.TS19, Items.VIPER9, Items.FLASHES, Items.AIR, Items.AIR, Items.AIR, Items.ELYTRA)),
    POLIZEI("polizei", ChatColor.translateAlternateColorCodes('&', "&8&l[&9UCPD&8&l]"), Arrays.asList(Items.LKEV, Items.TS19, Items.SCATTER3, Items.TAZER, Items.AIR, Items.AIR, Items.AIR, Items.AIR, Items.AIR)),
